          ...
          >
            <div class="feed-hd flex a-i-c j-c-s-b">
              <div class="avatar flex a-i-c">
                <img :src="teacherPhoto" width="40" height="40" radius="50" v-if="teacherPhoto" />
                <img src="@/assets/child-default@2x.png" width="40" height="40" radius="50" v-else />
                <p class="ml-20">{{ teacherName }}</p>
              </div>
              <div class>
                <time v-if="roleType == 2">{{ list.feedDate }}</time>
                <span style="color:#999" v-else>接收家长：{{studentName }}</span>
              </div>
            </div>
            <div class="feed-bd">
              <p v-html="title" ></p>
            ...
            <div class="feed-ft" v-if="roleType == 2">
              <div class="reply">
                <span style="color:#336d92">老师回复:</span>
                <span class="font-color">{{ list.replyTextContent }}</span>
              </div>
              <div class>
                <time>{{ list.replyDate }}</time>
              </div>
            </div>
          </div>
        </div>
